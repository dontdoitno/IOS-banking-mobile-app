...
struct CustomView1: View {
    ...
    @State public var text2Text: String = "Аккаунт и карты"
    ...
    @State public var text4Text: String = "Аккаунт 1"
    @State public var text5Text: String = "1900 8988 1234 3333"
    @State public var text6Text: String = "Баланс"
    @State public var text7Text: String = "Город"
    @State public var text8Text: String = "5 ₽"
    @State public var text9Text: String = "СПб"
    @State public var text10Text: String = "Аккаунт 2"
    @State public var text11Text: String = "1234 1234 1234 1234"
    @State public var text12Text: String = "Баланс"
    @State public var text13Text: String = "Город"
    @State public var text14Text: String = "12 000 ₽"
    @State public var text15Text: String = "СПб"
    @State public var text16Text: String = "Аккаунт 3"
    @State public var text17Text: String = "1900 1234 2222 3333"
    ...
    @State public var text23Text: String = "Карта"
    var body: some View {
