...
struct CustomView1: View {
    ...
    @State public var text3Text: String = "John Smith"
    @State public var text4Text: String = "Amazon Platinium"
    ...
    @State public var text15Text: String = "Add card"
    var body: some View {
        ZStack(alignment: .topLeading) {
            ...
            Image(image10Path)
                ...
                .offset(y: 778)
            CustomView11(text13Text: text13Text)
                .frame(width: 155, height: 44)
                .offset(x: 24, y: 108)
            CustomView13(text14Text: text14Text)
                .frame(width: 155, height: 44)
                .offset(x: 196, y: 108)
            CustomView15(text15Text: text15Text)
