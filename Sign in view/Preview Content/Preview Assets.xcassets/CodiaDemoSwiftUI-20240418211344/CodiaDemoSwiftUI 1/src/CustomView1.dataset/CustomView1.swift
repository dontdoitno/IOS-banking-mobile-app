...
struct CustomView1: View {
    @State public var text1Text: String = "Welcome Back"
    @State public var text2Text: String = "Hello there, sign in to continue"
    @State public var text3Text: String = "Forgot your password ?"
    @State public var image1Path: String = "image1_17391"
    @State public var text4Text: String = "Don't have an account? "
