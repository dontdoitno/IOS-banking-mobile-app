...
//  Banking App
//
//  Created by Anton Dementiev on 18.03.2024.
//
...
//        сама карточка
        ...
        .background(LinearGradient(colors: [Color.darkBlue, Color.normalBlue, Color.lightBlue], startPoint: .leading, endPoint: .trailing))
        .cornerRadius(20.0)
